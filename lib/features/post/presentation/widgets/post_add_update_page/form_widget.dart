...
import 'package:clean_architecture_posts_app/features/post/presentation/widgets/post_add_update_page/text_form_field_widget.dart';
...
class _FormWidgetState extends State<FormWidget> {
  ...
  void validateFormThenUpdateOrAddPost() {
    ...
    if (isValid) {
      ...
      if (widget.isUpdatePost) {
        BlocProvider.of<AddDeleteUpadatePostBloc>(context)
